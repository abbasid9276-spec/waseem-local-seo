...
export const caseStudies = [
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "Period", value: "May–Oct 2025" },
    ],
    work:
...
// Client testimonials, supplied and attributed by name with permission.
export const testimonials = [
  {
    quote:
      "We hired this local SEO expert in Pakistan to fix our Google My Business profile. Within two months our restaurant was showing up in the top 3 on Google Maps for 'near me' searches. Phone calls and walk-ins have nearly doubled.",
    author: "Abdul Azeem",
    detail: "Restaurant owner",
  },
  {
    quote:
      "We run a pest control service and were invisible on Google until we hired this local SEO expert in Pakistan. After he optimized our Google My Business profile, we started ranking in the top 3 on Google Maps for 'pest control near me'. We now get daily calls for termite treatment and fumigation, and most of our new customers find us on Google.",
