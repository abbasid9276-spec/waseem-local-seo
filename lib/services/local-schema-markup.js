export const service = {
  ...
  title: "Local Schema Markup Services | Be Understood Correctly",
  description:
    "Local schema markup built as one connected entity graph, so search engines and AI assistants can state what your business is without guessing.",
  excerpt:
